...
- **Confirm & block dates** . This marks those dates as booked. The calendar on the public
...
Edit on GitHub (pencil icon, change, then **Commit changes**), wait ~1–2 minutes. Note the
...
- **Changing prices** ($99 / $650, the $50 cleaning & prep fee, the sales-tax rate, which they
...
**History** to restore an earlier version, so nothing is ever lost.
